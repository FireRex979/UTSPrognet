          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action="/dosen/{{$dosen->id}}" method="POST">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="nama_dosen" value="{{$dosen->nama_dosen}}" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Email</label>
                <div class="col-sm-9">
                  <input type="email" class="form-control" name="emaildosen" value="{{$dosen->emaildosen}}" readonly>
                </div>
              </div>
              <div class="form-group row">
                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nomor Telepon</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="nomor_telepon" value="{{$dosen->nomor_telepon}}" readonly>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" name="alamat" value="{{$dosen->alamat}}" readonly>
                </div>
              </div>
              <div class="form-group row">
            ...
            <br>
            <a href="/dosen"><button class="btn btn-light">Kembali</button></a>
          </div>
        </div>
      </div>
@endsection